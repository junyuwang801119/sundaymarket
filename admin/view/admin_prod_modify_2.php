...
-->
          <div class="form-group row m-4">
            ...
            <textarea name="prod_content" class="form-control col-9" id="exampleFormControlTextarea1" placeholder="請輸入內文" rows="3"><?php echo $row_RS_prod['prod_content'];?></textarea>
          </div>
  ...
  <div class="modal-footer">
    <input type="hidden" name="prod_id" value="<?php echo $row_RS_prod['prod_id'];?>">
    ...
    <input type="submit" class="btn btn-info" value="確定更新" onclick="getTestData()">
  </div>
</form>
...
<script>
 ...
 var testData = {}
  function getTestData() {
    var testDataArr = {}
    testDataArr['prod_tnum'] = $('#prod_num').val()
    testDataArr['prod_tnum'] = $('#prod_num').val()
    testDataArr['prod_tnum'] = $('#prod_num').val()
    testDataArr['prod_tnum'] = $('#prod_num').val()
